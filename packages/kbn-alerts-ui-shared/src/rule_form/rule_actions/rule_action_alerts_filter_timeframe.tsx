...
import { AlertsFilterTimeframe, IsoWeekday, ISO_WEEKDAYS } from '@kbn/alerting-types';
...
interface RuleActionAlertsFilterTimeframeProps {
...
export const RuleActionAlertsFilterTimeframe = ({
  state,
  onChange,
}: RuleActionAlertsFilterTimeframeProps) => {
